...
$("#nav-donuts").click(function(e){
	...
	$("#nav-sandwiches").removeClass("selected");
	$("#nav-donuts").addClass("selected");
});

$("#nav-sandwiches").click(function(e){
	e.preventDefault();
	$("#drinks").hide();
	$("#donuts").hide();
	$("#sandwiches").show();

	$("#nav-donuts").removeClass("selected");
	$("#nav-drinks").removeClass("selected");
	$("#nav-sandwiches").addClass("selected");
});
...
$("a.nav-drinks").click(function(e){
	e.preventDefault();
	window.location.href="menu.html#drinks";
});

$("a.nav-sandwiches").click(function(e){
	e.preventDefault();
	window.location.href="menu.html#sandwiches";
});

$("a.nav-donuts").click(function(e){
	e.preventDefault();
	...
	$.each(obj, function(key, element) {
    	if ($(element).attr('id') == "sandwiches"){
    		$('html,body').scrollTop(0);
    		$("#nav-sandwiches").trigger('click');
    	}
    	else if ($(element).attr('id') == "drinks"){
    			$('html,body').scrollTop(0);
    			$("#nav-drinks").trigger('click');
    	}
	});
});
